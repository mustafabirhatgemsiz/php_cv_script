						...
						<div class="row">
							<form action="operation.php" method="POST" class="form-horizontal" role="form">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="skill_name" class="form-control" placeholder="Lütfen beceri adı giriniz.">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="skill_rate" class="form-control" placeholder="Lütfen beceri oranı giriniz.">
									</div>
								</div>

								<hr>
								<div class="col-md-11">
									<button class="btn btn-success pull-right" name="add-skill">Kaydet</button>
								</div>		 	
							</form>
						</div>
					</div>
